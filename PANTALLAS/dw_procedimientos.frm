...
Begin VB.Form dw_prodimientos 
   Caption         =   "SERVICIOS OLAP POR PROCEDIMIENTOS"
   ClientHeight    =   6795
   ClientLeft      =   1065
   ClientTop       =   2340
   ClientWidth     =   12795
   Icon            =   "dw_procedimientos.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6795
   ScaleWidth      =   12795
   Begin OWC.PivotTable PivotTable1 
      Bindings        =   "dw_procedimientos.frx":030A
      Height          =   5760
      Left            =   0
      TabIndex        =   0
      Top             =   0
      Width           =   7770
      XMLData         =   $"dw_procedimientos.frx":0324
   End
End
Attribute VB_Name = "dw_prodimientos"
